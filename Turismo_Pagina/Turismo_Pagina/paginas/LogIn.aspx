<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LogIn.aspx.cs" Inherits="Turismo_Pagina.paginas.LogIn" %>
...
<head>
    ...
    <title>Turismo Guatemala - Iniciar Sesión</title>
                        ...
                        <div class="col-md-6 fh5co-news">
                            <section>
                                <form method="post" runat="server">
                                    <br />
                                    <br />
                                    <h2><span class="icon-login "></span>Iniciar Sesión</h2>
                                    <a>Nombre de Usuario: </a>
                                    <br />
                                    <asp:TextBox ID="usuario" placeholder="Usuario" runat="server" class="cajaTexto"></asp:TextBox><br />
                                    <a>Contraseña: </a>
                                    <br />
                                    ...
                                    <br />
                                    <asp:Button ID="boton" runat="server" Text="Login" class="btn btn-primary btn-lg" OnClick="boton_Click" />
                                    <br />
                                    <br />
                                    <br />
                                </form>
