<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VerNoticia.aspx.cs" Inherits="Turismo_Pagina.paginas.VerNoticia" %>
    ...
    <div id="fh5co-wrapper">
        <div id="fh5co-page">
                        ...
                        <div class="nav-header">
                            ...
                            <nav id="fh5co-menu-wrap" role="navigation">
                                <ul class="sf-menu" id="fh5co-primary-menu">
                                    ...
                                    <li class="active">
                                        <a href="Catalogo.aspx">Ver Noticia</a>
                                    </li>
            ...
            <div class="fh5co-hero">
                ...
                <%
                    while (getNoticia().Read())
                    {
                        Object Imagen = getNoticia()["Fotografia"];
                        byte[] ImagenObtenida = (byte[])Imagen;
                        String ImagenDataURL64 = "data:image/jpg;base64," + Convert.ToBase64String(ImagenObtenida);

                %>
                <div class="fh5co-cover text-center" data-stellar-background-ratio="0.5" style="background-image: url(<%=ImagenDataURL64%>);">
                    <div class="desc animate-box">
                        <h2><%=getNoticia()["Titulo"] %></h2>
                    </div>
                </div>                
            </div>
                    ...
                    <form action="#" class="mostrardatos">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <p class="text-info"><%=getNoticia()["Descripcion"]%></p>
                                <a><i class="icon-calendar"></i>Fecha: </a> <a><%=getNoticia()["Fecha"] %></a>
                            </div>
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <h3 class="section-title">Noticia:</h3>
                                            <p class="text-info"><%=getNoticia()["Noticia"]%></p>
                                        </div>
                                    </div>                                    
                                </div>
                            </div>
