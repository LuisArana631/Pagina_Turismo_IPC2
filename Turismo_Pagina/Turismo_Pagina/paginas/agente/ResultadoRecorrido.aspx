<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResultadoRecorrido.aspx.cs" Inherits="Turismo_Pagina.paginas.agente.ResultadoRecorrido" %>
...
<head>
    ...
    <title>Turismo Guatemala - Resultados de Recorridos</title>
                    ...
                    <form method="post" runat="server" action="#" class="mostrardatos">
                        <asp:Table ID="Table1" runat="server" CssClass="table">
                            <asp:TableHeaderRow ID="encabezado" backcolo="white" runat="server">
                                <asp:TableHeaderCell Scope="Column">DPI Agente</asp:TableHeaderCell>
                                <asp:TableHeaderCell Scope="Column">Nombre Agente</asp:TableHeaderCell>
                                ...
                                <asp:TableHeaderCell Scope="Column">Resultado</asp:TableHeaderCell>
                                <asp:TableHeaderCell Scope="Column">Estado</asp:TableHeaderCell>                                
                                <asp:TableHeaderCell Scope="Column">Acciones</asp:TableHeaderCell>
                            </asp:TableHeaderRow>
                            <asp:TableRow>
                                <asp:TableCell>56432132461231</asp:TableCell>
                                <asp:TableCell>Chabelo</asp:TableCell>
                                <asp:TableCell>Vuelta al mundo</asp:TableCell>
                                <asp:TableCell>Muestra empresa</asp:TableCell>
                                <asp:TableCell>Aceptada</asp:TableCell>
                                <asp:TableCell>Inscrita</asp:TableCell>                                
                                <asp:TableCell>
                                    <asp:Button ID="ver" runat="server" Text="Ver" class="btn-success" OnClick="ver_Click" />
                                </asp:TableCell>
                            </asp:TableRow>
                        </asp:Table>
