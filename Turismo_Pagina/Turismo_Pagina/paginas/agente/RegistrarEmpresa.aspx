<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistrarEmpresa.aspx.cs" Inherits="Turismo_Pagina.paginas.agente.RegistrarEmpresa" %>
            ...
            <div id="fh5co-contact" class="fh5co-section animate-box">
                <div class="container">
                    <form method="post" runat="server" action="#" class="mostrardatos">                        
                        <asp:Table ID="TablaEmpresas" runat="server" CssClass="table" >
                            <asp:TableHeaderRow ID="encabezado" backcolo="white" runat="server">                                
                                <asp:TableHeaderCell Scope="Column">Nombre</asp:TableHeaderCell>
                                <asp:TableHeaderCell Scope="Column">Correo</asp:TableHeaderCell>
                                <asp:TableHeaderCell Scope="Column">Teléfono</asp:TableHeaderCell>
