<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VerRecorrido.aspx.cs" Inherits="Turismo_Pagina.paginas.agente.VerRecorrido" %>
...
<head>
    ...
    <title>Turismo Guatemala - Ver Recorrido</title>
                ...
                <header id="fh5co-header-section">
                    <div class="container">
                        <div class="nav-header">
                            ...
                            <h1 id="fh5co-logo"><a href="InicioAdministrador.aspx">Agente</a></h1>
                                ...
                                <li>
                                    ...
                                    <asp:Table ID="Table1" runat="server" CssClass="table">
                                        <asp:TableHeaderRow ID="encabezado" backcolo="white" runat="server">
                                            ...
                                            <asp:TableHeaderCell Scope="Column">Comentario</asp:TableHeaderCell>
                                        </asp:TableHeaderRow>
                                        <asp:TableRow>
                                            ...
                                            <asp:TableCell>Esta muy bonita la empresa</asp:TableCell>
                                        </asp:TableRow>
                                    </asp:Table>
                                </li>
                            </ul>
