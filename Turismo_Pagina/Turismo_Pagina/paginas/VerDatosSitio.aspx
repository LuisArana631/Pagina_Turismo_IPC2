<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VerDatosSitio.aspx.cs" Inherits="Turismo_Pagina.paginas.VerDatosSitio" %>
            ...
            <div id="fh5co-contact" class="fh5co-section animate-box">
                <div class="container">
                    <form action="#" class="mostrardatos">
                        <div class="row">
                            <div class="col-md-6">
                                <h3 class="section-title"><% =getSitio()["Nombre"] %></h3>
                                <p> <% =getSitio()["Descripcion"] %></p>
                                <a><i class="icon-map"></i> Región: </a> <a><%=getSitio()["Region"] %></a>
                            </div>
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-6">
