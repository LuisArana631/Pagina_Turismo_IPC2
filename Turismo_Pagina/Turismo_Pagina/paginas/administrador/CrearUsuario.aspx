<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CrearUsuario.aspx.cs" Inherits="Turismo_Pagina.paginas.administrador.CrearUsuario" %>
...
<head>
    ...
    <title>Turismo Guatemala - Registrar Usuario</title>
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <ul>
                                        ...
                                        <li>
                                            <asp:DropDownList ID="listTipo" runat="server" CssClass="list-group-item">
